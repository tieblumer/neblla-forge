...
export function aubePrompt({ threadText, steer, voz }) {
  return [
    ...
    '      - "facil": cambio trivial o mecánico; NO necesita tests.',
    '      - "mediana": necesita una batería MÍNIMA (camino feliz + 1-2 bordes críticos).',
    '      - "compleja": necesita cobertura completa (lógica con muchos caminos/bordes).',
    '    Ante la duda entre dos niveles, elige el MÁS alto (más seguro).',
